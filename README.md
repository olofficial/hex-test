...
2. Creating an `.obp` build file of 3$`\times`$3 cubes using a class and a grid of points. [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/olofficial/hex-test/9eb12aeea4c4080dbcaea17ae82c4c9b87afd80a?urlpath=lab%2Ftree%2Fcubes.ipynb)
